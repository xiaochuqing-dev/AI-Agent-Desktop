...
- Windows System、Hermes、cc-connect、Claude Code、Codex、CC Switch、Telegram Config 共 7 个发现/集成 Adapter；Hermes Telegram Native Adapter 只写官方公开 Telegram 配置面，不读取 Hermes 私有数据
- 全链路脱敏与源码 Secret 扫描
